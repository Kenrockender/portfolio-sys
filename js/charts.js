  ...
  if (hist.length < 2) {
    ...
    wrap.innerHTML = `<div style="position:relative;">
      ...
      <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-60%);text-align:center;pointer-events:none;">
        <div style="opacity:.35"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" width="32" height="32" style="display:block;margin:0 auto"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div>
